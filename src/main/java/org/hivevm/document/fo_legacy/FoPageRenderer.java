...
class FoPageRenderer implements PageRenderer<FoBlock> {
    ...
    public FoPageRenderer(Properties properties) {
    ...
    private void addAndReplaceText(String text, FoBlock block) {
        ...
        Matcher matcher = FoPageRenderer.LINK.matcher(text);
        while (matcher.find()) {
    ...
    private String replaceText(String text) {
        ...
        Matcher matcher = FoPageRenderer.ENV.matcher(text);
        while (matcher.find()) {
