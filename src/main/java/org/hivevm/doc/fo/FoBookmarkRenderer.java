...
import org.hivevm.doc.fo.writer.FoAbstract;
import org.hivevm.doc.fo.writer.FoBookmark;

import java.util.Stack;

public class FoBookmarkRenderer implements DocumentVisitor<FoAbstract> {
    ...
    @Override
    public final void visit(Document doc, FoAbstract tree) {
     ...
     */
    @Override
    public final void visit(Header node, FoAbstract tree) {
