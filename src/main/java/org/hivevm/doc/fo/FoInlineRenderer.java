 ...
 */
class FoInlineRenderer implements Flow.Visitor<FoNode> {
     ...
     */
    public FoInlineRenderer(Template template, Document document) {
    ...
    public final void visit(Flow.Link link, FoNode data) {
        ...
        FoDocumentRenderer.applyLinkStyle(basicLink, template);
        ...
        if (link.title() != null) {
            ...
            FoDocumentRenderer.applyLinkStyle(fn, template);
    ...
    public final void visit(Flow.Style style, FoNode data) {
        ...
        if (style.kinds().contains(Flow.Kind.CODE))
            FoDocumentRenderer.applyStyle(inline, "styled", template);
