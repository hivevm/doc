...
package org.hivevm.doc.fop.pdf;
...
class FontResolver implements ResourceResolver {
     ...
     * @param outputStream
     */
    public static void createFontMetric(InputStream inputStream, OutputStream outputStream)
            throws IOException {
        ...
        DOMSource source = new DOMSource(
                reader.constructFontXML(ttfFile, null, null, null, null, true, null));
