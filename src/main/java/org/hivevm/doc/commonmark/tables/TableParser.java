...
class TableParser extends AbstractBlockParser {
    ...
    private TableParser(List<Integer> columnWidth, List<TableCell.Alignment> columnAlign,
    ...
    private static void parseSeparator(CharSequence s, List<Integer> width,
                                       List<TableCell.Alignment> align) {
        int pipes = 0;
        boolean valid = false;
        int i = 0;
        int w = 0;
            ...
            if ((paragraph != null) && paragraph.getContent().contains("|") && !paragraph.toString()
                ...
                if ((align != null) && !align.isEmpty()) {
                    ...
                    if (align.size() >= headerCells.size()) {
                        return BlockStart.of(new TableParser(width, align, headerCells))
